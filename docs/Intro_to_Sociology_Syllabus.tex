...
\hypersetup{
  pdftitle={SOC 1120-02 and H02: Introduction to Sociology - Diversity \& Health},
...
\emph{When:} Monday and Wednesday, 2:10pm CST to 3:25pm CST

\emph{Where:} Morrissey Hall 0600
...
\textbf{Text or Call:} 314-884-0386 (Google Voice)
...
\hypertarget{core-requirements---new-core}{%
\section{\texorpdfstring{Core Requirements - \emph{New Core}}{Core Requirements - New Core}}\label{core-requirements---new-core}}

This course is part of the Saint Louis University Core, an integrated intellectual experience completed by all baccalaureate students, regardless of major, program, college, school or campus. The Core offers all SLU students the same unified approach to Jesuit education guided by SLU's institutional mission and identity and our nine undergraduate \href{https://www.slu.edu/provost/university-undergraduate-core/core-student-learning-outcomes.php}{Core Student Learning Outcomes} (SLOs).

\hypertarget{identities-in-context}{%
\subsection{Identities in Context}\label{identities-in-context}}

\textbf{Identities in Context} is one of 19 Core Components. The University Core SLO(s) that this component is designed to intentionally advance are listed below.

\hypertarget{university-core-student-learning-outcomes}{%
\subsubsection{University Core Student Learning Outcomes}\label{university-core-student-learning-outcomes}}
...
\hypertarget{component-level-student-learning-outcomes}{%
\subsubsection{Component-level Student Learning Outcomes}\label{component-level-student-learning-outcomes}}
...
\hypertarget{ways-of-thinking-social-and-behavioral-sciences}{%
\subsection{Ways of Thinking: Social and Behavioral Sciences}\label{ways-of-thinking-social-and-behavioral-sciences}}

\textbf{Ways of Thinking: Social and Behavioral Sciences} is one of 19 Core Components. The University Core SLO(s) that this component is designed to intentionally advance are listed below.

\hypertarget{university-core-student-learning-outcomes-1}{%
\subsubsection{University Core Student Learning Outcomes}\label{university-core-student-learning-outcomes-1}}
...
\hypertarget{component-level-student-learning-outcomes-1}{%
\subsubsection{Component-level Student Learning Outcomes}\label{component-level-student-learning-outcomes-1}}
...
\hypertarget{core-requirements---old-core}{%
\section{\texorpdfstring{Core Requirements - \emph{Old Core}}{Core Requirements - Old Core}}\label{core-requirements---old-core}}
...
\textbf{Canvas} is a learning management system similar to Google Classroom and Blackboard. We will use Canvas this semester for accessing all course materials, including assignments, grades, quizzes, course meeting slides and notes, and other links. Announcements and communications about the course will also come through Canvas, so it is important to check our Canvas site regularly.
...
\tightlist
\item
  Theory Isn't Dead 1 - \textbf{Wednesday, February 2}
\item
  Theory Isn't Dead 2 - \textbf{Monday, February 28}
\end{enumerate}
...
\tightlist
\item
  Sociological Experience 1 - High School - \textbf{Monday, February 14}
\item
  Sociological Experience 2 - Socioeconomic Status - \textbf{Monday, March 7}
\item
  Sociological Experience 3 - Segregation - \textbf{Monday, April 11}
\item
  Sociological Experience 4 - St.~Louis - \textbf{Wednesday, April 27}
\end{enumerate}
...
Due dates for the \emph{Mama} papers are as follows:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \emph{Mama} Paper 1 - \textbf{Monday, March 21}
\item
  \emph{Mama} Paper 2 - \textbf{Wednesday, April 13}
\item
  \emph{Mama} Paper 3 - \textbf{Monday, May 2}
\end{enumerate}
...
\tightlist
\item
  Quiz 1 - \textbf{Friday, February 18}
\item
  Quiz 2 - \textbf{Friday, April 1}
\item
  Quiz 3 - \textbf{Wednesday, May 11}
...
This semester, we will not have class on \textbf{March 15th}, \textbf{March 17}, and \textbf{April 18th} because they fall on University breaks. Additionally, no class activities are scheduled for \textbf{March 9th} or \textbf{May 9th}. These are ``flex days,'' which I have left without a scheduled plan to accommodate changes due to COVID-19. If we are approaching these dates without having had to use them, these will become days off from this course.
...
\hypertarget{meeting-1-1---wednesday-january-19---course-introduction}{%
\subsection*{Meeting 1-1 - Wednesday, January 19 - Course Introduction}\label{meeting-1-1---wednesday-january-19---course-introduction}}
\addcontentsline{toc}{subsection}{Meeting 1-1 - Wednesday, January 19 - Course Introduction}
...
\item
  ...
  \tightlist
  \item
    Complete the Student Information Sheet for Monday, January 24 (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-1-2---monday-january-24---social-theory}{%
\subsection*{Meeting 1-2 - Monday, January 24 - Social Theory}\label{meeting-1-2---monday-january-24---social-theory}}
\addcontentsline{toc}{subsection}{Meeting 1-2 - Monday, January 24 - Social Theory}
...
\item
  ...
  \item
    Complete the Student Information Sheet (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-1-3---wednesday-january-26---theorizing-health-disparities}{%
\subsection*{Meeting 1-3 - Wednesday, January 26 - Theorizing Health Disparities}\label{meeting-1-3---wednesday-january-26---theorizing-health-disparities}}
\addcontentsline{toc}{subsection}{Meeting 1-3 - Wednesday, January 26 - Theorizing Health Disparities}
...
\item
  ...
  \item
    ...
    \end{itemize}
  \item
    Watch \emph{Unnatural Causes}, Part 1 - ``In Sickness and in Wealth'' (Kanopy) and complete the accompanying entry ticket (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-1-4---monday-january-31---studying-society}{%
\subsection*{Meeting 1-4 - Monday, January 31 - Studying Society}\label{meeting-1-4---monday-january-31---studying-society}}
\addcontentsline{toc}{subsection}{Meeting 1-4 - Monday, January 31 - Studying Society}
...
\item
  ...
  \tightlist
  \item
    Complete Theory Isn't Dead 1 for Wednesday, February 2 (Canvas)
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-2-1---wednesday-february-2---nature-or-nurture}{%
\subsection*{Meeting 2-1 - Wednesday, February 2 - Nature or Nurture?}\label{meeting-2-1---wednesday-february-2---nature-or-nurture}}
\addcontentsline{toc}{subsection}{Meeting 2-1 - Wednesday, February 2 - Nature or Nurture?}
...
\hypertarget{meeting-2-2---monday-february-7---social-structure}{%
\subsection*{Meeting 2-2 - Monday, February 7 - Social Structure}\label{meeting-2-2---monday-february-7---social-structure}}
\addcontentsline{toc}{subsection}{Meeting 2-2 - Monday, February 7 - Social Structure}
...
\hypertarget{meeting-2-3---wednesday-february-9---socialization}{%
\subsection*{Meeting 2-3 - Wednesday, February 9 - Socialization}\label{meeting-2-3---wednesday-february-9---socialization}}
\addcontentsline{toc}{subsection}{Meeting 2-3 - Wednesday, February 9 - Socialization}
...
\item
  ...
  \tightlist
  \item
    Complete Sociological Experience 1 - High School for Monday, February 14 (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-2-4---monday-february-14---the-institution-of-medicine}{%
\subsection*{Meeting 2-4 - Monday, February 14 - The Institution of Medicine}\label{meeting-2-4---monday-february-14---the-institution-of-medicine}}
\addcontentsline{toc}{subsection}{Meeting 2-4 - Monday, February 14 - The Institution of Medicine}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      Wright, Eric and Brea Perry. 2010. ``Medical Sociology and Health Services Research: Past Accomplishments and Future Policy Challenges.'' \emph{Journal of Health and Social Behavior} 51(S):S107-S119. (Link)
    \end{itemize}
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-2-5---wednesday-february-16---medicalization}{%
\subsection*{Meeting 2-5 - Wednesday, February 16 - Medicalization}\label{meeting-2-5---wednesday-february-16---medicalization}}
\addcontentsline{toc}{subsection}{Meeting 2-5 - Wednesday, February 16 - Medicalization}
...
\item
  ...
  \tightlist
  \item
    Study for Quiz 1 on Friday, February 18 (Canvas)
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-3-1---monday-february-21---decoding-culture}{%
\subsection*{Meeting 3-1 - Monday, February 21 - Decoding Culture}\label{meeting-3-1---monday-february-21---decoding-culture}}
\addcontentsline{toc}{subsection}{Meeting 3-1 - Monday, February 21 - Decoding Culture}
...
\hypertarget{meeting-3-2---wednesday-february-23---culture-and-health}{%
\subsection*{Meeting 3-2 - Wednesday, February 23 - Culture and Health}\label{meeting-3-2---wednesday-february-23---culture-and-health}}
\addcontentsline{toc}{subsection}{Meeting 3-2 - Wednesday, February 23 - Culture and Health}
...
\item
  ...
  \tightlist
  \item
    Watch \emph{Unnatural Causes}, Part 3 - ``Becoming American'' (Kanopy) and complete the accompanying entry ticket (Canvas)
  \item
    Complete Theory Isn't Dead 2 for Monday, February 28 (Canvas)
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-4-1---monday-february-28---social-class}{%
\subsection*{Meeting 4-1 - Monday, February 28 - Social Class}\label{meeting-4-1---monday-february-28---social-class}}
\addcontentsline{toc}{subsection}{Meeting 4-1 - Monday, February 28 - Social Class}
...
\hypertarget{meeting-4-2---wednesday-march-2---inequality-and-poverty}{%
\subsection*{Meeting 4-2 - Wednesday, March 2 - Inequality and Poverty}\label{meeting-4-2---wednesday-march-2---inequality-and-poverty}}
\addcontentsline{toc}{subsection}{Meeting 4-2 - Wednesday, March 2 - Inequality and Poverty}
...
\item
  ...
  \tightlist
  \item
    Complete Sociological Experience 2 for Monday, March 7 (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-4-3---monday-march-7---socioeconomic-status-and-health}{%
\subsection*{Meeting 4-3 - Monday, March 7 - Socioeconomic Status and Health}\label{meeting-4-3---monday-march-7---socioeconomic-status-and-health}}
\addcontentsline{toc}{subsection}{Meeting 4-3 - Monday, March 7 - Socioeconomic Status and Health}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      Dow, William H. and David H. Rehkopf. 2010. ``Socioeconomic gradients in health in international and historical context.'' \emph{Annals of the New York Academy of Sciences} 1186:24-36. (Link)
    \end{itemize}
  \end{itemize}
\item
  \textbf{After Class:}
  ...
  \tightlist
  \item
    Watch \emph{Unnatural Causes}, Part 7 - ``Not Just a Paycheck'' (Kanopy) and complete the accompanying exit ticket (Canvas)
  \item
    Make sure you are wrapping up \emph{Mama} Paper 1 for Monday, March 21 (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-4-4---monday-march-21---mama-discussion-1}{%
\subsection*{\texorpdfstring{Meeting 4-4 - Monday, March 21 - \emph{Mama} Discussion 1}{Meeting 4-4 - Monday, March 21 - Mama Discussion 1}}\label{meeting-4-4---monday-march-21---mama-discussion-1}}
\addcontentsline{toc}{subsection}{Meeting 4-4 - Monday, March 21 - \emph{Mama} Discussion 1}
...
\hypertarget{meeting-5-1---wednesday-march-23---gender-and-health}{%
\subsection*{Meeting 5-1 - Wednesday, March 23 - Gender and Health}\label{meeting-5-1---wednesday-march-23---gender-and-health}}
\addcontentsline{toc}{subsection}{Meeting 5-1 - Wednesday, March 23 - Gender and Health}
...
\hypertarget{meeting-5-2---monday-march-28---sexuality-and-health}{%
\subsection*{Meeting 5-2 - Monday, March 28 - Sexuality and Health}\label{meeting-5-2---monday-march-28---sexuality-and-health}}
\addcontentsline{toc}{subsection}{Meeting 5-2 - Monday, March 28 - Sexuality and Health}
...
\item
  ...
  \tightlist
  \item
    Study for Quiz 2 on Friday, April 1 (Canvas)
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-6-1---wednesday-march-30---race-and-racism-1}{%
\subsection*{Meeting 6-1 - Wednesday, March 30 - Race and Racism 1}\label{meeting-6-1---wednesday-march-30---race-and-racism-1}}
\addcontentsline{toc}{subsection}{Meeting 6-1 - Wednesday, March 30 - Race and Racism 1}
...
\hypertarget{meeting-6-2--monday-april-4---race-and-racism-2}{%
\subsection*{Meeting 6-2 -Monday, April 4 - Race and Racism 2}\label{meeting-6-2--monday-april-4---race-and-racism-2}}
\addcontentsline{toc}{subsection}{Meeting 6-2 -Monday, April 4 - Race and Racism 2}
...
\hypertarget{meeting-6-3---wednesday-april-6---race-and-racism-3}{%
\subsection*{Meeting 6-3 - Wednesday, April 6 - Race and Racism 3}\label{meeting-6-3---wednesday-april-6---race-and-racism-3}}
\addcontentsline{toc}{subsection}{Meeting 6-3 - Wednesday, April 6 - Race and Racism 3}
...
\item
  ...
  \tightlist
  \item
    Complete Sociological Experience 3 for Monday, April 11 (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-6-4---monday-april-11---racism-and-health}{%
\subsection*{Meeting 6-4 - Monday, April 11 - Racism and Health}\label{meeting-6-4---monday-april-11---racism-and-health}}
\addcontentsline{toc}{subsection}{Meeting 6-4 - Monday, April 11 - Racism and Health}
...
\item
  ...
  \tightlist
  \item
    Watch \emph{Unnatural Causes}, Part 4 - ``Bad Sugar'' (Kanopy) and complete the accompanying exit ticket (Canvas)
  \item
    Make sure you are wrapping up \emph{Mama} Paper 2 for Wednesday, April 13 (Canvas)
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-7-1---wednesday-april-13---mama-discussion-2}{%
\subsection*{\texorpdfstring{Meeting 7-1 - Wednesday, April 13 - \emph{Mama} Discussion 2}{Meeting 7-1 - Wednesday, April 13 - Mama Discussion 2}}\label{meeting-7-1---wednesday-april-13---mama-discussion-2}}
\addcontentsline{toc}{subsection}{Meeting 7-1 - Wednesday, April 13 - \emph{Mama} Discussion 2}
...
\hypertarget{meeting-7-2---wednesday-april-20---intersectionality-and-health}{%
\subsection*{Meeting 7-2 - Wednesday, April 20 - Intersectionality and Health}\label{meeting-7-2---wednesday-april-20---intersectionality-and-health}}
\addcontentsline{toc}{subsection}{Meeting 7-2 - Wednesday, April 20 - Intersectionality and Health}
...
\item
  ...
  \tightlist
  \item
    Watch \emph{Unnatural Causes}, Part 2 - ``When the Bough Breaks'' (Kanopy) and complete the accompanying exit ticket (Canvas)
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-8-1---monday-april-25---urban-america}{%
\subsection*{Meeting 8-1 - Monday, April 25 - Urban America}\label{meeting-8-1---monday-april-25---urban-america}}
\addcontentsline{toc}{subsection}{Meeting 8-1 - Monday, April 25 - Urban America}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      Prener, Christopher. 2020. ``Finding the city in sociology: Broadening and deepening the geographic scope of the urban and inequality literatures.'' \emph{Sociology Compass} 14(2):e12756. (Link)
    \end{itemize}
  \end{itemize}
\item
  \textbf{After Class:}
  ...
  \tightlist
  \item
    Complete Sociological Experience 4 for Wednesday, April 27 (Canvas)
  \end{itemize}
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{meeting-8-2---wednesday-april-27---cities-and-health}{%
\subsection*{Meeting 8-2 - Wednesday, April 27 - Cities and Health}\label{meeting-8-2---wednesday-april-27---cities-and-health}}
\addcontentsline{toc}{subsection}{Meeting 8-2 - Wednesday, April 27 - Cities and Health}
...
\item
  ...
  \tightlist
  \item
    Watch \emph{Unnatural Causes}, Part 5 - ``Place Matters'' (Kanopy) and complete the accompanying exit ticket (Canvas)
  \item
    Make sure you are wrapping up \emph{Mama} Paper 3 for Monday, May 2 (Canvas)
  \end{itemize}
\end{itemize}
...
\hypertarget{meeting-9-1---monday-may-2---mama-discussion-3}{%
\subsection*{\texorpdfstring{Meeting 9-1 - Monday, May 2 - \emph{Mama} Discussion 3}{Meeting 9-1 - Monday, May 2 - Mama Discussion 3}}\label{meeting-9-1---monday-may-2---mama-discussion-3}}
\addcontentsline{toc}{subsection}{Meeting 9-1 - Monday, May 2 - \emph{Mama} Discussion 3}
...
\hypertarget{meeting-9-2---wednesday-may-4---course-conclusion}{%
\subsection*{Meeting 9-2 - Wednesday, May 4 - Course Conclusion}\label{meeting-9-2---wednesday-may-4---course-conclusion}}
\addcontentsline{toc}{subsection}{Meeting 9-2 - Wednesday, May 4 - Course Conclusion}
...
\item
  ...
  \tightlist
  \item
    Study for Quiz 3 on Wednesday, May 11 (Canvas)
  \item
    Complete the Final Project, which is due on Monday, May 16 (Canvas)
  \end{itemize}
\end{itemize}
