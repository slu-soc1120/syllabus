...
\hypersetup{unicode=true,
            pdftitle={SOC 1120-02: Introduction to Sociology - Diversity \& Health},
...
\setlength{\droptitle}{-2em}
  ...
  \title{SOC 1120-02: Introduction to Sociology - Diversity \& Health}
...
You will need an invitation to \textbf{Google Classroom} from Chris. Invitations will be sent to all enrolled students before the first class. If you enroll after the first day of class, please let Chris know that you will need an invitation. Inivtations will be sent to your SLU associated Google account, which consists of your \emph{computer login} (e.g. \texttt{doej} for Jane Doe) entered as an email - \texttt{doej@slu.edu}. The password will be the same as your password used to login to mySLU and SLU computers. Using another Google account for this course is not permitted.

In order to faciliate quick access to course materials, each lecture's section of the \href{/lecture-schedule.html}{\textbf{Reading List}} will include a button that links to that lecture's post with lecture slides and notes. The button will look like this for posts that are available:
...
Assignments will also be linked from the \href{/lecture-schedule.html}{\textbf{Reading List}} to the relevant post on the \texttt{Stream}. These will be noted with a hyperlink in paranetheses that looks like this: (Google Classroom)
...
\addcontentsline{toc}{subsection}{Lecture 02 - Wednesday, January 16\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{\emph{No Class} - Monday, January 21\textsuperscript{st} - Martin Luther King, Jr.~Day}
...
\addcontentsline{toc}{subsection}{Lecture 03 - Wednesday, January 23\textsuperscript{rd}}
...
\addcontentsline{toc}{subsection}{Lecture 04 - Monday, January 28\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 05 - Wednesday, January 30\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 06 - Monday, February 4\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 07 - Wednesday, February 6\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Exam 01 - Monday, February 11\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 08 - Wednesday, February 13\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 09 - Monday, February 18\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 10 - Wednesday, February 20\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 11 - Monday, February 25\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 12 - Wednesday, February 27\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 13 - Monday, March 4\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 14 - Wednesday, March 6\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{\emph{No Class} - Spring Break}
...
\tightlist
\item
  Civil Rights Division. 2015. \emph{Investigation of the Furgeson Police Department}. Washington, DC: U.S. Department of Justice. (Link)
...
\addcontentsline{toc}{subsection}{Lecture 15 - Monday, March 18\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 16 - Wednesday, March 20\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Exam 02 - Monday, March 25\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 17 - Wednesday, March 27\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 18 - Monday, April 1\textsuperscript{st}}
...
\addcontentsline{toc}{subsection}{Lecture 19 - Wednesday, April 3\textsuperscript{rd}}
...
\addcontentsline{toc}{subsection}{Lecture 20 - Monday, April 8\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 21 - Wednesday, April 10\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 22 - Monday, April 15\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 23 - Wednesday, April 17\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{\emph{No Class} - Monday, April 22\textsuperscript{nd} - Easter Break}
...
\addcontentsline{toc}{subsection}{Lecture 24 - Wednesday, April 24\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 25 - Monday, April 29\textsuperscript{th}}
...
\addcontentsline{toc}{subsection}{Lecture 26 - Wednesday, May 1\textsuperscript{st}}
...
\addcontentsline{toc}{subsection}{Lecture 27 - Monday, May 6th\textsuperscript{th}}
...
\addcontentsline{toc}{section}{Week 18}

\hypertarget{exam-03---tba}{%
\subsection*{Exam 03 - TBA}\label{exam-03---tba}}
\addcontentsline{toc}{subsection}{Exam 03 - TBA}
...
You should pick a topic from \href{/honors-seminar-topics.html}{the honors seminar topic list} that they would like to present on during one of the related class lecture periods. Topic selection for this assignment can occur independently of the selection of seminar topics, and no more than one student can present on a single topic. Once you have settled on a topic, let Chris know. Topics will be ``reserved'' on a first-come, first-served basis.

With a topic in-hand, you should read ahead and pick \emph{one narrow aspect} of the readings that you want to learn more about and present on. You are \emph{strongly} encouraged to meet with Chris after selecting your narrow focus area to make sure it is appropriate for the assignment. You should complete additional background research on the topic, and put together an (approximately) ten minute presentation that introduces students to the area. Presentation is conceived of broadly here, and you should feel free to search for creative ways to communicate your topic with the class. Again, you are encouraged to meet with Chris to discuss this aspect of the assignment.
...
To keep the points simple, 5 points will automatically be added to the sum of your three repsonse papers so that they total to a possible 200 points (since \texttt{65\ x\ 3\ =\ 195}).
