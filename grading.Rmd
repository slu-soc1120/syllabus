...
Due dates for the Theory Post are as follows:
  ...
  1. Theory Isn't Dead 1 - **`r schedule_tbl$label[4]`**
  2. Theory Isn't Dead 2 - **`r schedule_tbl$label[10]`**
...
Due dates for the Sociological Experiences are as follows:
  ...
  1. Sociological Experience 1 - High School - **`r schedule_tbl$label[7]`**
  2. Sociological Experience 2 - Socioeconomic Status - **`r schedule_tbl$label[12]`**
  3. Sociological Experience 3 - Segregation - **`r schedule_tbl$label[19]`**
  4. Sociological Experience 4 - St. Louis - **`r schedule_tbl$label[24]`**
...
Due dates for the QHQs are as follows:
  ...
  1. QHQ Paper 1 - **`r schedule_tbl$label[14]`**
  2. QHQ Paper 2 - **`r schedule_tbl$label[21]`**
  3. QHQ Paper 3 - **`r schedule_tbl$label[25]`**
