...
### Meeting 01 - `r schedule_tbl$label[1]` - Course Introduction {-}
...
### Meeting 02 - `r schedule_tbl$label[2]` - Social Theory {-}
...
### Meeting 03 - `r schedule_tbl$label[3]` - Theorizing Health Disparities {-}
...
### Meeting 04 - `r schedule_tbl$label[4]` - Studying Society {-}
...
### Meeting 05 - `r schedule_tbl$label[5]` - Nature or Nurture? {-}
...
### Meeting 06 - `r schedule_tbl$label[6]` - Social Structure {-}
...
### Meeting 07 - `r schedule_tbl$label[7]` - Socialization {-}
...
### Meeting 08 - `r schedule_tbl$label[8]` - Medicalization {-}
...
### Meeting 09 - `r schedule_tbl$label[9]` - Decoding Culture {-}
...
### Meeting 10 - `r schedule_tbl$label[10]` - Culture and Health {-}
...
### Meeting 11 - `r schedule_tbl$label[11]` - Social Class {-}
...
### Meeting 12 - `r schedule_tbl$label[12]` - Inequality and Poverty {-}
...
### Meeting 13 - `r schedule_tbl$label[13]` - Socioeconomic Status and Health {-}
...
### Meeting 14 - `r schedule_tbl$label[14]` - QHQ 1 Discussion {-}
...
### Meeting 15 - `r schedule_tbl$label[15]` - Gender and Health {-}
...
### Meeting 16 - `r schedule_tbl$label[16]` - Sexuality and Health {-}
...
### Meeting 17 - `r schedule_tbl$label[17]` - Race and Racism 1 {-}
...
### Meeting 18 -`r schedule_tbl$label[18]` - Race and Racism 2 {-}
...
### Meeting 19 - `r schedule_tbl$label[19]` - Race and Racism 3 {-}
...
### Meeting 20 - `r schedule_tbl$label[20]` - Racism and Health {-}
...
### Meeting 21 - `r schedule_tbl$label[21]` - QHQ 2 Discussion {-}
...
### Meeting 22 - `r schedule_tbl$label[22]` - Intersectionality and Health {-}
...
### Meeting 23 - `r schedule_tbl$label[23]` - Urban America {-}
...
### Meeting 24 - `r schedule_tbl$label[24]` - Cities and Health {-}
...
### Meeting 25 - `r schedule_tbl$label[25]` - QHQ 3 Discussion {-}
...
### Meeting 26 - `r schedule_tbl$label[26]` - Course Conclusion {-}
